...
function is_it_won(two_dimensional_array) {
...
function is_it_solved(two_dimensional_array){
    let available_moves = two_dimensional_array.filter(row=>row.includes(" ")).length
    return (is_it_won(two_dimensional_array)||available_moves===0) ? true : false 
}
